...
export type ModuleKey = 'dashboard' | 'narrative' | 'visuals' | 'characters' | 'video' | 'sound' | 'organization';
...
const iconClasses = "h-6 w-6 mr-3 text-gray-400 group-hover:text-indigo-400 transition-colors duration-200";
...
export const MODULES: Record<ModuleKey, ModuleInfo> = {
  ...
  narrative: {
    name: 'Narrativa',
    icon: <svg xmlns="http://www.w3.org/2000/svg" className={iconClasses} fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 6.253v11.494m0 0a7.5 7.5 0 007.5-7.5H4.5a7.5 7.5 0 007.5 7.5z" /></svg>,
    component: NarrativeModule,
  },
  visuals: {
    name: 'Artes Visuais',
    icon: <svg xmlns="http://www.w3.org/2000/svg" className={iconClasses} fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z" /></svg>,
    component: VisualArtsModule,
  },
  characters: {
    name: 'Personagens',
